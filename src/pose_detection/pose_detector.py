...
class PoseDetector:
    def __init__(self, 
        ...
        # Lista de landmarks de interés según la consigna
        ...
        # Mapeo de índices a nombres para facilitar la comprensión
        self.landmark_names = {
            0: "nose",
    ...
    def detect_pose(self, image):
        ...
        # Dibujar landmarks y conexiones si hay detecciones
        if results.pose_landmarks:
            # Dibujar todos los landmarks y conexiones
    ...
    def extract_landmarks(self, results, normalize=True):
        ...
        # Si vamos a normalizar, calcular el centro de la cadera como punto de referencia
        if normalize:
            # Centro de la cadera (promedio entre cadera izquierda y derecha)
            ...
            # Distancia entre hombros para normalizar la escala
            ...
            scale_factor = 1.0 / max(shoulder_distance, 1e-6)  # Evitar división por cero
        ...
        for landmark_idx in self.landmarks_of_interest:
            ...
            if normalize:
                # Normalizar coordenadas respecto al centro de la cadera y escala
    ...
    def calculate_joint_angles(self, landmarks_dict):
        ...
        # Calcular ángulo de la rodilla izquierda (entre cadera, rodilla y tobillo)
        ...
        # Calcular ángulo de la rodilla derecha
        ...
        # Calcular ángulo de la cadera izquierda (entre hombro, cadera y rodilla)
        ...
        # Calcular ángulo de la cadera derecha
        ...
        # Calcular ángulo del codo derecho
        ...
        # (ángulo entre la línea vertical y la línea que une los hombros)
        left_shoulder = landmarks_dict['left_shoulder']
        right_shoulder = landmarks_dict['right_shoulder']
        
        # Vector que va del hombro derecho al izquierdo
        shoulder_vector = {
        ...
        # Vector vertical (paralelo al eje y)
        vertical_vector = {'x': 0, 'y': 1, 'z': 0}
        
        # Calcular el ángulo entre estos vectores proyectados en el plano frontal (x-y)
    ...
    def process_frame(self, frame, frame_idx=None):
        ...
        # Si no se detectó ninguna pose, devolver None
        if not landmarks_dict:
        ...
        # Añadir información visual de los ángulos al frame
        if angles:
            # Mostrar ángulos principales
            y_pos = 30
    ...
    def save_landmarks_to_csv(self, landmarks_list, output_path):
        ...
        # Filtrar frames donde no se detectaron landmarks
        ...
        # Crear un DataFrame con los datos de todos los frames
        rows = []
        for item in valid_landmarks:
            ...
            # Añadir las coordenadas de cada landmark
...
if __name__ == "__main__":
    ...
    # Ejemplo de uso con la webcam
    cap = cv2.VideoCapture(0)
    
    # Lista para almacenar landmarks
    landmarks_list = []
    ...
    try:
        ...
        # Guardar landmarks si hay suficientes
